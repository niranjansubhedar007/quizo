...
setShowModalDelete(false)
  ...
  // );
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#583D72] to-[#4a3560] flex">
      {/* Sidebar */}
      <div className="w-64 bg-[#583D72] border-r border-[#FF8474] text-white p-4 shadow-lg fixed h-screen overflow-y-auto">
